...
PACKAGENAME = metadata.get('package_name', 'servicemon')
DESCRIPTION = metadata.get('description', 'Measure/monitor VO service performance')
AUTHOR = metadata.get('author', 'Tom Donaldson')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: servicemon requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
